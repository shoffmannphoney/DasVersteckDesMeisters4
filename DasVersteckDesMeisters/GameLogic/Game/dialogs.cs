...
namespace GameCore
{
    ...
    public partial class Order: AbstractOrder
    {
        ...
        public void BookDialog(MCMenu mcM, List<int> tFollower, List<int> cFollower)
        {
            ...
            cFollower.Add(100);
            mcM.Add(MCMenuEntry.MCMenuEntryLoca(CA!.Person_Self, "Book_Dialog_Gunnar", 100, 200, false, false));
            mcM.Last()!.SetSpeaker(CB!.VT_sagen);

            cFollower.Add(101);
            mcM.Add(MCMenuEntry.MCMenuEntryLoca(CA!.Person_Self, "Book_Dialog_Teleports", 101, 210, false, false));
            mcM.Last()!.SetSpeaker(CB!.VT_sagen);

            cFollower.Add(102);
            mcM.Add(MCMenuEntry.MCMenuEntryLoca(CA!.Person_Self, "Book_Dialog_Sextips", 102, 220, false, false));
            mcM.Last()!.SetSpeaker(CB!.VT_sagen);

            cFollower.Add(103);
            mcM.Add(MCMenuEntry.MCMenuEntryLoca(CA!.Person_Self, "Book_Dialog_Mondsteine", 103, 230, false, false));
            mcM.Last()!.SetSpeaker(CB!.VT_sagen);

            cFollower.Add(199);
            mcM.Add(MCMenuEntry.MCMenuEntryLoca(CA!.Person_Self, "Book_Dialog_Ende", 199, -1, false, false));
            mcM.Last()!.SetSpeaker(CB!.VT_sagen);
