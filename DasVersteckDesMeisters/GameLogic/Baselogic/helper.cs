...
namespace GameCore
{
    ...
    public static class Helper
    {
        ...
        public static string? ShrinkQuotationMark( string? s)
        {
            ...
            {
                GlobalData.AddLog("ShrinkQuotationMark: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return null;
                // int a = 5;
            }
        ...
        public static string? FirstUpper(string? s)
        {
            ...
            {
                GlobalData.AddLog("FirstUpper: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return null;
            }
        ...
        */
        ...
        public static string? InsertString(string? s, params object[] obj)
        {
            ...
            {
                GlobalData.AddLog("InsertString: " + e.Message + " String: " + s, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return null;
            }
        ...
        public static string? InsertNonequals(string? s, params object[] obj)
        {
            ...
            {
                GlobalData.AddLog("InsertNonequals: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return null;
            }
        ...
        static int SearchVT(string s)
        {
            ...
            {
                GlobalData.AddLog("SearchVT: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return 0;
            }
        ...
        static int SearchlocationID(string s)
        {
            ...
            {
                GlobalData.AddLog("SearchlocationID: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return 0;
            }
        ...
        static int SearchDir(string s)
        {
            ...
            {
                GlobalData.AddLog("SearchDir: " + e.Message, Phoney_MAUI.Model.IGlobalData.protMode.crisp);
                return 0;
            }
