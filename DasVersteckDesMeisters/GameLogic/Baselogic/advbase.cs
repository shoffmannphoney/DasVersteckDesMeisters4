    ...
    public class AdvData
    {
        ...
        { 
            ...
            set
            {
                ...
                {
                    Phoney_MAUI.Core.GlobalData.AddLog("ActLoc Setter: " + e.Message, IGlobalData.protMode.crisp);
                }
        ...
        */
        ...
        public string GetConvertedText(string Description)
        {
            ...
            */
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("GetConvertedText: " + e.Message, IGlobalData.protMode.crisp);
                return null;
            }
    ...
    public class AdvBase
    {
       ...
       public ItemQueue? ItemQueue { get; set; }
        ...
        public bool DoGameLoopIfSuccess(ParseLineList? ptlSignatures = null)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("DoGameLoopIfSuccess: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool CollectNouns()
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("CollectNouns: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool DoGameLoop(string s, ParseTokenList? ptl = null, ParseLineList? ptlSignatures = null)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("DoGameLoop: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool WaitForCondition(Person person, DelVoid conditionMethod)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("WaitForCondition: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool WaitForWanderer(Person? person, int destLoc)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("WaitForWanderer: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool PictureOutput(string picName)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("PictureOutput: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool StoryOutput(int locationID, Person? PersonID, string? Text, bool SuppressOrderEntry = false)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("StoryOutput: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public bool FeedbackOutput(Person PersonID, string text, bool sys = false)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("FeedbackOutput: " + e.Message, IGlobalData.protMode.crisp);
                return false;
            }
        ...
        public ParseLineList? LoadPLL()
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("LoadPLL: " + ex.Message, IGlobalData.protMode.crisp);
                return null;
...
#pragma warning restore CS0168 // Die Variable "PT" ist deklariert, wird aber nie verwendet.
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("InitializeGeneralGameData: " + ex.Message, IGlobalData.protMode.crisp);
        ...
        */
        ...
        public void SetScoreToken(Score? score)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SetScoreToken: " + ex.Message, IGlobalData.protMode.crisp);
        ...
        public void SetScoreOutput()
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SetScoreOutput: " + ex.Message, IGlobalData.protMode.crisp);
        ...
        int SearchVT(string s)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SearchVT: " + ex.Message, IGlobalData.protMode.crisp);
                return 0;
            }
        ...
        public int SearchItemID(string s)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SearchItemID: " + ex.Message, IGlobalData.protMode.crisp);
                return 0;
            }
        ...
        public int SearchlocationID(string s)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SearchlocationID: " + ex.Message, IGlobalData.protMode.crisp);
                return 0;
        ...
        public int SearchDir(string s)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("SearchDir: " + ex.Message, IGlobalData.protMode.crisp);
                return 0;
        ...
        public string Insert(string s, params object[] obj)
        {
            ...
            {
                Phoney_MAUI.Core.GlobalData.AddLog("advbase.insert: " + ex.Message, IGlobalData.protMode.crisp);
                return null;
